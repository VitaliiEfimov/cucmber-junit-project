...
public class WebTableOrder_StepDef {
    ...
    public void user_is_already_logged_in_and_on_order_page() {
        ...
        webTableLoginPage.login(ConfigurationReader.getProperty("userNameWebTableLoginPage"),ConfigurationReader.getProperty("passwordWebTableLoginPage"));
...
//        }
    ...
    public void user_enters_process_order_button() {
        ...
        webTableOrderPage.viewAllOrdersNavItemButton.click();
    }
