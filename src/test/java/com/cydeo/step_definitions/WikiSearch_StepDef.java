...
public class WikiSearch_StepDef {
    ...
    public void user_clicks_wiki_search_button() {
        wikiSearchPage.wikiSearchBtn.click();
    }
    ...
    public void userTypesInTheWikiSearchBox(String searchKeyWord) {
        wikiSearchPage.wikiSearchBox.sendKeys(searchKeyWord);
    }
    @Then("User sees {string} is in the wiki title")
    public void userSeesIsInTheWikiTitle(String string) {
        Assert.assertTrue("Title verification with String is failed",Driver.getDriver().getTitle().contains(string));
    }
